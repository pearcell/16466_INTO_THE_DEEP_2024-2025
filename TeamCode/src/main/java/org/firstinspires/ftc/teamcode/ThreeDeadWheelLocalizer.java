...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1714.886858853573; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1749.2556196065875; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2092.3872777946112; // x position of the perpendicular encoder (in tick units)
    }
