...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1771.1217994425672; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2092.512390222932; // x position of the perpendicular encoder (in tick units)
    }
