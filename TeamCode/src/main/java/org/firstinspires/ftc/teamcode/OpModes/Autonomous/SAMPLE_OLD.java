...
@Disabled
@Autonomous
public class SAMPLE_OLD extends LinearOpMode {
    @Override
    ...
    //initialize trajectories
        ...
        TrajectoryActionBuilder grab2 = score1.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(57.7, 54.5), Math.toRadians(-86));
        ...
        TrajectoryActionBuilder grab3 = score2.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(58.1, 52.5), Math.toRadians(-62.7));
        ...
        TrajectoryActionBuilder park = score3.endTrajectory().fresh()
                ...
                .splineToLinearHeading(new Pose2d(new Vector2d(23, 11), Math.toRadians(-90)), Math.toRadians(180));
